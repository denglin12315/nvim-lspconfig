...
local on_attach = function(client, bufnr)
	...
	vim.keymap.set("n", "<leader>f", vim.lsp.buf.definition, bufopts)
	vim.keymap.set("n", "<leader>v", vim.lsp.buf.implementation, bufopts)
	vim.keymap.set("n", "<leader>c", vim.lsp.buf.incoming_calls, bufopts)
	vim.keymap.set("n", "<leader>x", vim.lsp.buf.outgoing_calls, bufopts)
